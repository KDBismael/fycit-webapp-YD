...
const verificationBadges = [
  { name: 'AMPAS', status: 'verified' as const },
  { name: 'ADG', status: 'pending' as const },
  { name: 'ASIFA', status: 'pending' as const },
  { name: 'ASC', status: 'verifiable' as const },
];
...
export default function DashboardPage() {
    ...
    const verifiableGuilds = verificationBadges.filter(
      (badge) => badge.status === 'verifiable' || badge.status === 'verified'
    );
